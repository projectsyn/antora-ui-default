...
Font Awesome icons: follow us on icon:instagram[] icon:twitter[] or icon:facebook[]

Black-Scholes Equation:

stem:[\frac{\partial V}{ \partial t } + \frac{1}{2}\sigma^{2} S^{2} \frac{\partial^{2} V}{\partial S^2} + r S \frac{\partial V}{\partial S}\ - r V = 0]
